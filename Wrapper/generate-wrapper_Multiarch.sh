...
run() {
	...
	#-debug-tmsearch
	swig -Wall -c++ -java -package "de.dhbw.rahmlab."$wrapLibName".impl" -outdir "$swigJavaOutDir" -o "$currentTmp/"$wrapLibName"_wrap.cpp" -I"$wrapLibInclude" ./PlatformIndependent.i
}
